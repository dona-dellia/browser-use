...
sensitive_data = {'x_name': "Eduardo_Cavalcanti", 'x_password': password}
...
initial_actions = [
	...
	{"input_text":{"index":18,"text":"R_RODRIGUES"}},
	{"input_text":{"index":24,"text":password}},
...
agent = Agent(
		task=("""
1. open the Change Object page
2. select the Change Object Type field and choose ECO as the only option
3. select the Status field and choose Success as the only option
4. select the Regions Affected field and choose DAO AND EMEA as the only option
